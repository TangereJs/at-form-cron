...
(function ($) {
    ...
    function jqCron(settings, formCron) {
        ...
        var _$blockMinsPeriod = $('<span class=jqCron-mins-period></span>');
        ...
        var _selectors = [];
        var _selectorPeriod, _selectorMins, _selectorMinsPeriod, _selectorTimeH, _selectorTimeM, _selectorDow, _selectorDom, _selectorMonth;
        ...
        this.getCron = function () {
            ...
            var items = ['*', '*', '*', '*', '*'];
            if (period == 'minute') {
                items[0] = '*/' + _selectorMinsPeriod.getCronValue();
            }
            if (period == 'hour') {
            ...
            var r = (items.join(' '));
            if (r == '*/0 * * * *') r = '*/1 * * * *'; // change every 0 min -> every 1 min
        ...
        this.setCron = function (str) {
            ...
            try {
                ...
                if (mask == '*-****') {						// 1 possibility
                    ...
                    _selectorMinsPeriod.setCronValue(items[0]);
                }
        ...
        this.init = function () {
            ...
            _$blocks.append(_$blockMinsPeriod);
            ...
            _selectorPeriod.$.bind('selector:change', function (e, value) {
                ...
                _$blockMONTH.hide();
                _$blockMINS.hide();
                _$blockMinsPeriod.hide();
                _$blockDOW.hide();
                _$blockTIME.hide();
                if (value == 'minute') {
                    _$blockMinsPeriod.show();
                }
                if (value == 'hour') {
                    _$blockMINS.show();
                }
            ...
            // MINS (period minutes)
            _$blockMinsPeriod.append(_self.getText('text_mins_period'));
            _selectorMinsPeriod = newSelector(_$blockMinsPeriod, false);
            for (i = 0, list = settings.minutes; i < list.length; i++) {
                _selectorMinsPeriod.add(list[i], list[i]);
            }
